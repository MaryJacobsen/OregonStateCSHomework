...
public class ForecastItemDetailActivity extends AppCompatActivity {
    ...
    public void shareForecast() {
        ...
        String units = preferences.getString(getString(R.string.pref_unit_key), getString(R.string.pref_unit_default));
        ...
        if (mForecastItem != null) {
            ...
            String shareText = getString(R.string.forecast_item_share_text, location, dateString, mForecastItem.temperature, WeatherPreferences.getDefaultTemperatureUnitsAbbr(units), mForecastItem.description);
    ...
    private void fillInLayout(OpenWeatherMapUtils.ForecastItem forecastItem) {
        ...
        String detailString = getString(R.string.forecast_item_details, forecastItem.temperature,
                WeatherPreferences.getDefaultTemperatureUnitsAbbr(units), forecastItem.description);
        String lowHighTempString = getString(R.string.forecast_item_low_high_temp,
                ...
                WeatherPreferences.getDefaultTemperatureUnitsAbbr(units));
