...
public class MainActivity extends AppCompatActivity
        implements ForecastAdapter.OnForecastItemClickListener, SharedPreferences.OnSharedPreferenceChangeListener, LocationAdapter.OnNavigationItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCityItemViewModel = ViewModelProviders.of(this).get(CityItemViewModel.class);
        ...
        mCityItemViewModel.getAllCityItems().observe(this, new Observer<List<CityItem>>() {
            @Override
            public void onChanged(@Nullable List<CityItem> cityItems) {
                mLocationAdapter.updateLocations(cityItems);
            }
        });
    }
    ...
    @Override
    public void onNavigationItemClicked(CityItem location) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(getString(R.string.pref_location_key), location.city_name);
        editor.apply();
    ...
    public void addLocationToDB(SharedPreferences sharedPreferences) {
        CityItem mCity = new CityItem();
        mCity.city_name = null;
        ...
        if(location != null) {
            mCity.city_name = location;
            mCityItemViewModel.insertCityItem(mCity);
        }
    }
