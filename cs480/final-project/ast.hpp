...
public:
  virtual ~ASTNode() {}
  virtual llvm::Value* generateGVSpec() const = 0;
};
...
public:
  ...
  virtual llvm::Value* generateGVSpec() const;
};
...
public:
  ...
  virtual llvm::Value* generateGVSpec(std::string nodeName, std::string& gvSpec) const;
};*/
